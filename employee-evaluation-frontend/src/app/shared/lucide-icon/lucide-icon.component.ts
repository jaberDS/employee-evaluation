...
export type IconName =
  | 'layout-dashboard' | 'users' | 'megaphone' | 'user-circle' | 'clipboard-list'
  | 'clipboard-check' | 'calendar' | 'bell' | 'search' | 'settings' | 'log-out'
  | 'trending-up' | 'star' | 'award' | 'activity' | 'check-circle' | 'clock'
  | 'bar-chart-3' | 'chevron-right' | 'chevron-left' | 'chevron-up' | 'chevron-down'
  | 'user-plus' | 'rocket' | 'moon' | 'sun' | 'pen-square' | 'file-text' | 'check-double'
  | 'zap' | 'pie-chart' | 'arrow-right' | 'sparkles' | 'menu' | 'x' | 'alert-triangle'
  | 'eye' | 'trash-2' | 'pen' | 'filter' | 'chevrons-up-down' | 'play' | 'pause'
  | 'list' | 'mail' | 'user' | 'crown' | 'shield' | 'layers' | 'hash' | 'arrow-up-down'
  | 'badge' | 'lock' | 'save' | 'info' | 'arrow-left' | 'tag' | 'user-check'
  | 'list-checks' | 'plus' | 'minus' | 'eye-off' | 'alert-circle' | 'list-x' | 'help-circle'
  | 'align-left' | 'plus-circle' | 'check' | 'toggle-left' | 'type' | 'message-square'
  | 'list-plus' | 'check-square'
  | 'user-cog' | 'user-x' | 'x-circle' | 'thumbs-up' | 'thumbs-down'
  | 'building' | 'landmark' | 'target' | 'briefcase' | 'sliders-horizontal'
  | 'gauge' | 'file-check'
  | 'key' | 'fingerprint' | 'smartphone' | 'qr-code' | 'refresh-cw'
  | 'loader' | 'scan-face' | 'shield-check' | 'circle-dot';
...
const ICONS: Record<IconName, string> = {
  ...
  'activity': '<path d="M22 12h-2.48a2 2 0 0 0-1.93 1.46l-2.35 8.36a2 2 0 0 1-3.88 0l-2.35-8.36A2 2 0 0 0 6.48 12H4"/>',
  ...
  'list-x': '<path d="m3 17 2 2 4-4"/><path d="m3 7 2 2 4-4"/><path d="M13 6h8"/><path d="M13 12h8"/><path d="m17 18 2 2"/><path d="m19 18-2 2"/>',
...
export class LucideIconComponent {
  @Input() name: IconName = 'layout-dashboard';
  @Input() size = 20;
  @Input() strokeWidth = 2;
  @Input() className = '';
